...
public class CoordinatesManager {
    ...
    double screensize2worldsize(double size) {
        return point.modulo(vecscreen2vecworld(new point(size,0)));
    }
    void touch() {
        numfingers=0;
    }
    ...
    void touch(point screenfinger1,point screenfinger2) {
        ...
        if (numfingers!=2) {
            ...
            //if(pm.thereIsSelected()){
            //    pm.getSelected().moveBetweenReferences(o1, ox1, oy1, o2, ox2, oy2);
            //    worldfinger1 =  newworldfinger1;
            //    worldfinger2 =  newworldfinger2;
            //}
            //else {
                point newO = point.pointFromReference
                        (point.pointToReference(O, o2, ox2, oy2), o1, ox1, oy1);
